...
Version 26.1-r3
------------------------------------------------------
- add scanErrorless registry helper

------------------------------------------------------
Version 26.1-r2
------------------------------------------------------
- fix ambiguity in addParticles method

------------------------------------------------------
Version 26.1-r1
------------------------------------------------------
- update to 26.1
- fix https://github.com/MoriyaShiine/strawberrylib/issues/3

------------------------------------------------------
Version 1.21.11-r4
------------------------------------------------------
- add supporter data api
...
------------------------------------------------------
- update to 1.21.11
- add registerEntitySubPredicateType registry helper
...
Version 1.21.10-r6
------------------------------------------------------
- https://github.com/MoriyaShiine/strawberrylib/issues/2
