...
public class PlayerMixin extends EntityMixin {
	@Override
	protected void slib$modelReplacementMuffledStepSound(BlockState blockState, BlockPos pos, CallbackInfo ci) {
		if (SLibUtils.getModelReplacement((Player) (Object) this) instanceof LivingEntity replacement) {
			StrawberryLibService.INSTANCE.playMuffledStepSound(replacement, blockState, pos);
			ci.cancel();
		}
	}
}
